...
class ClassificationDataPipeline(ImagePipeline):
    ...
    def load_dataset(self, test=False, IMG_WIDTH=256, IMG_HEIGHT=None):
...
class SegmentationDataPipeline(ImagePipeline):
    # Assumes data directory structure: data_path_string/ then annotations and images in different folders
